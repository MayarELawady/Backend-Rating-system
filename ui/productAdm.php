		...
		<div class="home_container">
			<div class="home_content">
				...
				<div class="breadcrumbs">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li><a href="Admin2.php">Adminstration</a></li>
						<li><a href="Admin1.php">Categories</a></li>
						...
						<div class="product_content_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
							...
							<div class="product_sidebar order-lg-2 order-1">
								<form action="#" id="product_form" class="product_form">
									...
									<div class="similar_products_button trans_200"><a href="Admin2.php">Manage</a></div>
									<div class="similar_products_button trans_200"><a href="Admin1.php">see similar products</a></div>
								</form>
