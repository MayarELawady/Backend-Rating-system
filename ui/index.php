...
<div class="super_container">
	...
	<div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
		...
		<div class="menu_search">
			<form action="productsearchuser.php" class="header_search_form menu_mm" method="POST">
...
<form action="../php.php" method="POST">
		...
		<!-- Search -->
		<div class="search">
			<form action="../ui/productsearchuser.php" class="search_form" id="sidebar_search_form" method="POST">
				...
				<div class="owl-item">
					...
					<div class="home_content_container">
						<div class="home_content">
							...
							<div class="home_title">NEW PRODUCTS</div>
							<div class="button button_1 home_button trans_200"><a href="categories.php">GO NOW!</a></div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							...
							<div class="box_title trans_200"><a href="categories.php">summer collection</a></div>
						</div>
					</div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							...
							<div class="box_title trans_200"><a href="categories.php">eyewear collection</a></div>
						</div>
					</div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							...
							<div class="box_title trans_200"><a href="categories.php">basic pieces</a></div>
						</div>
					</div>
					...
					<div class="col text-center">
						<div class="categories_list_container">
							<ul class="categories_list d-flex flex-row align-items-center justify-content-start">
								...
								<li><a href="categories.php">recommended</a></li>
						...
						<div class="products_container grid">
							...
							<div class="product grid-item hot">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="product.php">long red shirt</a></div>
										<div class="product_price">$39.90</div>
										<div class="product_button ml-auto mr-auto trans_200"><a href="cart.php">add review</a></div>
									</div>
								</div>	
							</div>
							...
							<div class="product grid-item">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="product.php">hype grey shirt</a></div>
							...
							<div class="product grid-item sale">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="product.php">long sleeve jacket</a></div>
							...
							<div class="product grid-item">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="product.php">denim men shirt</a></div>
