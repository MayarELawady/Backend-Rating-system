	...
	<div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
		...
		<nav clais="menu_nav">
			<ul class="menu_mm">
				...
				<form action ="../php.php" method="POST">
				<button type ="submit" name="logout"class="newsletter_buttonLOG">Logout</button>
				<button type ="submit" name="view" class="buttonuser" >Viewallusers</button></i></a>
				</form>
			</ul>
		</nav>
	...
	<div class="sidebar">
		...
		<nav class="sidebar_nav">
			<ul>
				...
				<form action= "../php.php" method="POST">
				<button type ="submit" name="logout" class="newsletter_buttonLOG" >Logout</button></i></a>
				<button type ="submit" name="view" class="buttonuser" >Viewallusers</button></i></a>
</form>
				...
				<div class="owl-item">
					...
					<div class="home_content_container">
						<div class="home_content">
							...
							<div class="button button_1 home_button trans_200"><a href="#">GO NOW!</a></div>
						</div>
					</div>
				</div>
						...
						<div class="products_container grid">
							...
							<div class="product grid-item hot">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="productAdm.php">long red shirt</a></div>
										<div class="product_price">$39.90</div>
										<div class="product_button ml-auto mr-auto trans_200"><a href="productAdm.php">Manage</a></div>
							...
							<div class="product grid-item">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="productAdm.php">hype grey shirt</a></div>
							...
							<div class="product grid-item sale">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="productAdm.php">long sleeve jacket</a></div>
							...
							<div class="product grid-item">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="productAdm.php">denim men shirt</a></div>
