	...
	<div class="home">
		...
		<div class="home_container">
			<div class="home_content">
				<div class="home_title">JOIN US NOW!</div>
					...
					<div class="col">
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="billing checkout_box">
								<div class="checkout_title">WELCOME !</div>
								<div class="checkout_form_container">
									<form action="../php.php" id="checkout_form" class="checkout_form" method="POST">
										<div class="row">
											<div class="col-lg-6">
												...
												<input type="text" name="fname"id="checkout_name" class="checkout_input" required="required">
											</div>
											<div class="col-lg-6">
												<!-- Last Name -->
												<label for="checkout_last_name">Last Name*</label>
												<input name="lname"type="text" id="checkout_last_name" class="checkout_input" required="required">
											</div>
										</div>
										<div>
											<!-- Email -->
											<label for="checkout_email">Email Address*</label>
											<input name="semail"type="email" id="checkout_email" class="checkout_input" required="required">
										</div>
										<div>
											<!-- Email -->
											<label for="checkout_email">Password*</label>
											<input name="password"type="password" id="checkout_email" class="checkout_input" required="required">
										</div>
										...
										<div>
											...
											<input name="add" type="text" id="checkout_address" class="checkout_input" required="required">
									...
									<input type="submit" name="signup" value="sign up" class="checkout_button trans_200">
