							...
							<div class="products_bar_content d-flex flex-column flex-xxl-row align-items-start align-items-xxl-center justify-content-start">
								<div class="product_categories">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
										<li class="active"><a href="#"class="item_filter_btn" data-filter="*">All</a></li>
										<li><a href="#"class="item_filter_btn" data-filter=".hot">Hot Products</a></li>
										<li><a href="#"class="item_filter_btn" data-filter=".new">New Products</a></li>
										<li><a href="#" class="item_filter_btn" data-filter=".sale">Sale Products</a></li>
									</ul>
								</div>
							...
							<div class="product grid-item hot">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										...
										<div class="product_button ml-auto mr-auto trans_200"><a href="cart.php">View Reviews</a></div>
										<div class="product_button ml-auto mr-auto trans_200"><a href="productsearchuser.php">View Product</a></div>
									</div>
								</div>	
							</div>
