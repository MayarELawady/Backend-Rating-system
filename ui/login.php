	...
	<div class="sidebar">
		...
		<nav class="sidebar_nav">
			<ul>
				...
				<li><a href="signup.php">Sign up<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
			</ul>
		</nav>
				...
				<div class="col-lg-8 offset-lg-2">
					<div class="newsletter_content text-center">
						...
						<div class="newsletter_form_container">
							<form action="../php.php" id="newsletter_form" class="newsletter_form" method="POST">
								<input type="email" name ="email" class="newsletter_input" placeholder="your e-mail here" required="required">
								<input type="password" name = "lpassword" class="newsletter_input" placeholder="your password here" required="required">
								
								<button type="submit" class="newsletter_button" name ="login">Log in</button>
							</form>
						</div>
					</div>
				</div>
